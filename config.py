...
BOT_USERNAME = environ.get("BOT_USERNAME", "NarutoMovAni_bot") # without @
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://kgnbotz.blogspot.com/2025/02/file-store-bot.html") # For More Information Check Video On Yt - @Tech_VJ
